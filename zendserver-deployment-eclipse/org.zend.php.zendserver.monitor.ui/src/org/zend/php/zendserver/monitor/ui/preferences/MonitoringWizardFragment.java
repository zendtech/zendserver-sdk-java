...
public class MonitoringWizardFragment extends WizardFragment {

	protected MonitoringCompositeFragment composite;
	...
	public Composite createComposite(Composite parent, IWizardHandle wizard) {
		composite = new MonitoringCompositeFragment(parent,
