...
public class DevCloudDetailsComposite extends AbstractTargetDetailsComposite {
	...
	public Composite create(Composite parent) {
		...
		usernameText.setToolTipText(Messages.DevCloudDetailsComposite_UsernameTooltip);
		...
		passwordText.setToolTipText(Messages.DevCloudDetailsComposite_PasswordTooltip);
	...
	public IZendTarget createTarget(String[] data) throws SdkException, IOException {
		...
		if ((target != null) && (target.length > 0)) {
			return target[0]; // TODO support adding many targets from single account
		}
