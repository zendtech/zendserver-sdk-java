...
public class PropertiesColorManager {
	...
	/**
	 * Creates a new Properties color manager which automatically disposes the
	 * allocated colors when the current display gets disposed.
	 */
	public PropertiesColorManager() {
		this(true);
	}

	/**
	 * Creates a new Properties color manager.
	 * 
	 ...
	 *            are ignored.
	 */
	public PropertiesColorManager(boolean autoDisposeOnDisplayDispose) {
