...
public class Messages extends NLS {
	...
	public static String OpenShiftEulaPage_AgreeLabel;
	public static String OpenShiftEulaPage_EulaDescription;
	...
	public static String OpenShiftTargetPage_DoNotMatchError;
	...
	public static String OpenShiftTargetPage_PasswordLabel;
	public static String OpenShiftTargetPage_PasswordTooltip;
	public static String OpenShiftTargetPage_SameTargetErrorMessage;
	public static String OpenShiftTargetPage_TargetGroupLabel;
	public static String OpenShiftTargetPage_TargetNameLabel;
	public static String OpenShiftTargetPage_TooLongError;
	public static String OpenShiftTargetPage_TooShortError;
	public static String OpenShiftTargetPage_ZendServerGroupLabel;
