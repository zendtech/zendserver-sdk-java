...
public class ZendServerDependencyDetailsPage implements IDetailsPage {
	...
	private IZendServerDependency input;
	...
	public void selectionChanged(IFormPart part, ISelection selection) {
		...
		if (ssel.size()==1) {
			input = (IZendServerDependency)ssel.getFirstElement();
		}
		else
			input = null;
	...
	public void createContents(Composite parent) {
		...
		s1.setText("Zend Server dependency details");
		s1.setDescription("Specify required Zend Server version.");
		s1.marginWidth = 5;
		s1.marginHeight = 5;
