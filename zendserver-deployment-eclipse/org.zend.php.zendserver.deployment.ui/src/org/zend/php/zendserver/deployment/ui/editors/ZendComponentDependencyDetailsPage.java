...
public class ZendComponentDependencyDetailsPage implements IDetailsPage {
	...
	public void createContents(Composite parent) {
		...
		s1.setText("Zend Server Component Dependency details");
		s1.setDescription("Specify component dependency details.");
		s1.marginWidth = 5;
		s1.marginHeight = 5;
		...
		nameLabel = toolkit.createLabel(client, "Component name");
