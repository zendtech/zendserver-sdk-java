...
public class DescriptorContainerManager {
	...
	public static final String DESCRIPTOR_PATH = "zend_app_package.xml";
	...
	/**
	 * Should be removed because descriptor may not neccesairly be in project root
	 * 
	 * @param project
	 * @return
	 * @deprecated
	...
	public IDescriptorContainer openDescriptorContainer(IProject project) {
		IFile file = project.getFile((DescriptorContainerManager.DESCRIPTOR_PATH));
