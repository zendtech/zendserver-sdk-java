...
import org.zend.php.zendserver.deployment.debug.ui.preferences.DebugModePreferencesPage;
import org.zend.sdklib.target.IZendTarget;

public class DebugModePreferencesHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (target != null) {
			...
			PreferenceDialog dialog = PreferencesUtil.createPreferenceDialogOn(
					shell, DebugModePreferencesPage.ID,
					new String[] { DebugModePreferencesPage.ID }, target);
			dialog.open();
		}
		return null;
	}
