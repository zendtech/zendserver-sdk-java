...
/**
 * Get thelibrary version id that is deployed on the server or the cluster and
 * information about that version and its library.
 * 
 * Request Parameters:
 * <table border="1">
 * <tr>
 ...
 * 
 */
public class LibraryVersionGetStatusRequest extends AbstractRequest {

	private static final ResponseCode[] RESPONSE_CODES = new ResponseCode[] { ResponseCode.OK };

	public LibraryVersionGetStatusRequest(WebApiVersion version, Date date,
	...
	protected String getRequestName() {
		return "libraryVersionGetStatus";
	}
