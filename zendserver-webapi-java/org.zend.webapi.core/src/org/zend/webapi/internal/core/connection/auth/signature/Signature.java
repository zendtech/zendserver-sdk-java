...
public class Signature implements ISignature {
	...
	/* (non-Javadoc)
	 * @see org.zend.webapi.core.signature.ISignature#generate(java.lang.String, java.util.Date)
	 */
	public String encode(String requestUri, String date) throws SignatureException {
